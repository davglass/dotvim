...
hi Normal		guifg=cyan	guibg=black
hi Identifier   guifg=orange gui=bold
hi NonText		guifg=brown
hi Function     guifg=white	gui=bold
hi SCFunction   guifg=orange	gui=bold
hi comment		guifg=green
hi constant		guifg=cyan	gui=bold
hi statement	guifg=lightblue	gui=NONE
hi preproc		guifg=Pink2
...
hi FoldColumn	guibg=gray30 guifg=white
hi cIf0			guifg=gray
hi Boolean      guifg=black guibg=yellow
hi JSCSS        guifg=gold
hi javaScriptValue guifg=white
hi javaScriptNull gui=bold guifg=white
